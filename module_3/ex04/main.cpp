...
int     main( void )
{
    SuperTrap   big_trap("Never snow");
    ScavTrap    man("Groul");

    big_trap.rangedAttack("brear");
    big_trap.meleeAttack("Scav");
    big_trap.ninjaShoebox(man);
    big_trap.vaultHunter_dot_exe("bear");
    big_trap.takeDamage(40);
    big_trap.beRepaired(15);
